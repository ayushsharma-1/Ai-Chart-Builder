...
exports.inferMetricLineage = inferMetricLineage;
exports.estimateQueryConfidence = estimateQueryConfidence;
exports.buildAiExplanation = buildAiExplanation;
exports.buildChartExplainability = buildChartExplainability;
...
function inferMetricLineage(input) {
    ...
    return semanticMetrics_1.SEMANTIC_METRICS
        .map((metric) => {
...
function estimateQueryConfidence(input) {
    const factors = [];
    let score = 40;
    const sql = input.sql || '';
...
function buildAiExplanation(input) {
...
function buildChartExplainability(input) {
    return {
